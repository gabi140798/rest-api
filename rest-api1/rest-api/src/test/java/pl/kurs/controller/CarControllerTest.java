...
class CarControllerTest {
    ...
    public void shouldReturnSingleCar() throws Exception {
        int id = carRepository.saveAndFlush(new Car("BMW", "M5", "g")).getId();
    ...
    public void shouldAddCar() throws Exception {
        ...
        CreateCarCommand command = new CreateCarCommand("car", "CAR", "C");
    ...
    public void shouldDeleteCar() throws Exception {
        int carId = carRepository.saveAndFlush(new Car("car", "CAR", "C")).getId();
